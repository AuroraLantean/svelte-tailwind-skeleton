<script lang="ts">
	...
	export const getToastOk = (
		mesg: string = 'Transaction processed successfully!'
	): ToastSettings => {
		return {
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				...
				on:click={() => handleEthBalance(input)}>Get ETH Balance</button
			>
		{/if}
		<div class="mt-2 ml-2">
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				type="button"
				class="btn variant-filled-primary"
				on:click={() => hErc20BalanceOf(input)}>Get Token Balance</button
			>
		{/if}
		<div class="mt-2 ml-2">
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				type="button"
				class="btn variant-filled-primary"
				on:click={() => hErc20Allowance(input)}>Get Token Allowance</button
			>
		{/if}
		<div class="mt-2 ml-2">
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				...
				on:click={() => console.log('clicked for getNativeBalcM()')}>Get Native Balance</button
			>
		{/if}
		<div class="mt-2 ml-2">
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				type="button"
				class="btn variant-filled-secondary"
				on:click={() => console.log('clicked for getTokbalcsM()')}>Get Token Balances</button
			>
		{/if}
		<div class="mt-2 ml-2">
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				type="button"
				class="btn variant-filled-secondary"
				on:click={() => console.log('clicked for getNftmetadataM()')}>Get NFT Metadata</button
			>
		{/if}
		<div class="mt-2 ml-2">
	...
	<div class="flex flex-row">
		...
		{:else}
			<button
				type="button"
				class="btn variant-filled-primary"
				on:click={() => hErc721BalanceOf(input)}>Get NFT Balance</button
			>
		{/if}
		<div class="mt-2 ml-2">
